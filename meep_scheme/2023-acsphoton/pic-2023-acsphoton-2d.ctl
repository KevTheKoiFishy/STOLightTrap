...
(define-param Ly-BTO 0.500) ; 
(define-param Ly-SiO2-bottom 1) ; 

(define-param size-y (+ Ly-air-top Ly-BTO Ly-SiO2-bottom)   )     
...
(set! geometry (list
			...
			(make block 
				(center 0 (+ (/ Ly-BTO -2) (/ Ly-SiO2-bottom -2) ) 0) 
				(size infinity Ly-SiO2-bottom infinity) 
				(material SiO2)
			)
